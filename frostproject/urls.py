...
urlpatterns = [
    ...
    re_path(
        r"^ui/smstaff/(?P<db>[^/]+)/edit/(?P<staff_id>-?\d+)/$",
        sm_staff_ui_edit_inn,
    ...
    path(
        "maxbot/scenarios/<int:scenario_id>/questions/<int:question_id>/set-first/",
        views.maxbot_question_set_first,
        name="maxbot_question_set_first",
    ),
