...
# from frostapp.models import User, QRCode, UKMUser, Store
...
#                         "⛔ Ротация остановлена. Пароли не изменялись.\n"
#                         f"Причина: {error_text}\n"
#                         f"Время до остановки: {elapsed:.1f}s"
#                     )
#                     return
...
#                 f"ukm5_mode={'submit_only' if ukm5_submit_only else 'verify'}"
#             )
...
#                 info["error"] = (
#                     "Пароль не изменён: нет ни одного магазина, "
...
#                         "org_inn_check": org_check,
#                         "sync": {
#                             "ukm4": {"status": "skipped_dry_run", "error": ""},
#                             "ukm5": {"status": "skipped_dry_run", "error": ""},
#                         },
#                     })
...
#             logger.info(
#                 f"[ROTATE][USER] user_id={user.id} "
#                 f"new_password={masked} len={len(new_password)} "
#                 f"eligible_stores={len(eligible_links)}"
#             )

#             # В PostgreSQL пароль меняем только после того, как хотя бы один
#             # магазин прошёл проверку ИНН организации.
